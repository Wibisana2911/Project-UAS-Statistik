    ...
    <script>
      ...
      var chart = new Graph({
        ...
        <section class="w-full rounded-xl mt-10">
            <div id="main" class="w-full h-full main-content flex-1 bg-gray-300 md:mt-2 pb-24 md:pb-5 mt-10">

                <div class="bg-gray-100 pt-3">
                    <div
                        class="rounded-tl-3xl bg-gradient-to-r from-blue-500 to-yellow-600 p-4 shadow text-2xl text-white">
                        <h1 class="font-bold pl-2">Tambahkan Data</h1>
                    </div>
                </div>
                <div
                        ...
                        <div class="justify-center w-60">
                            <form action="/dataupdate" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-6">
                                    ...
                                    {{-- I'm editing this part start --}}
                                    <input type="text" name="Name" id="desc"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-96 block p-2.5">
                                    {{-- I'm editing this part end --}}
                                </div>
                                <div class="mb-6">
                                    <label for="score"
                                ...
                                <button type="submit"
                                    class="focus:outline-none text-white bg-blue-700 hover:bg-gray-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">Tambahkan</button>
                            </form>
                        </div>
                    </div>
                </div>
