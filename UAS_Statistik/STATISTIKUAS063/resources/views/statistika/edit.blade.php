...
<head>
    ...
    <title>STATISTIK UAS 063/Edit</title>
        ...
        <section class="w-full rounded-xl mt-10">
            <div id="main" class="w-full h-full main-content flex-1 bg-gray-300 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="bg-gray-100 pt-3">
                    <div
                        class="rounded-tl-3xl bg-gradient-to-r from-blue-700 to-yellow-700 p-4 shadow text-2xl text-white">
                    ...
                    <div class="container flex item-center">
                        ...
                        <div class="container">
                            <form action="/admin/{{ $data->id }}" method="POST"
                                ...
                                <button type="submit"
                                    class="focus:outline-none text-white bg-blue-700 hover:bg-gray-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">Edit</button>
                            </form>
                        </div>
                    </div>
                </div>
